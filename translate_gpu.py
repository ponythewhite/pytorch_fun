...
# -*- coding: utf-8 -*-
"""
Created on Mon Feb 13 17:31:25 2017
...
def readLangs(lang1, lang2, reverse=False):
    ...
    lines = codecs.open('data/%s-%s.txt' % (lang1, lang2), "r", "utf-8").read().strip().split('\n')
...
attn_decoder1 = AttnDecoderRNN(hidden_size, output_lang.n_words, 1, dropout_p=0.1).cuda()
trainEpochs(encoder1, attn_decoder1, 75000, print_every=2000)
